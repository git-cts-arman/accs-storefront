...
export default async function decorate(block) {
  ...
  const handlePlaceOrder = async ({ cartId, code }) => {
    ...
    try {
      ...
      console.warn('Checkout place order failed:', error);
      window.alert('Unable to place order right now. Please review payment details and try again.');
    } finally {
