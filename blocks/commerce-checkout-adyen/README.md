# Commerce Checkout Adyen Block

## Overview

The Commerce Checkout Adyen block provides a comprehensive **one-page checkout** experience with dynamic form handling, payment processing, address management, and order placement. It extends the default checkout behavior with Adyen session-based payment support.

Supported Adyen method codes:
...
Required storefront config keys in `config.json`:

- `adyen-payment-methods-endpoint`
- `adyen-checkout-session-endpoint`
- `adyen-country-code`
- `adyen-shopper-locale`
- `adyen-environment`
