...
import {
  createAdyenPaymentMethodSlots,
  getAdyenFallbackSlot,
} from './payment-methods/adyen.js';

const DISABLED_PAYMENT_METHOD_CODES = Object.freeze([
  'checkmo',
  'banktransfer',
  'banktransferpayment',
  'bank_transfer',
...
const getDisabledPaymentMethodSlots = () => DISABLED_PAYMENT_METHOD_CODES.reduce((slots, code) => {
  slots[code] = { enabled: false };
  return slots;
}, {});
